\begin{tblr}{colspec = {Q[l,wd=3.0cm] l l l l l c}, font=\footnotesize, rowsep=1pt, row{1} = {font=\bfseries\footnotesize}}
\hline\hline
...
{\footnotesize\textsuperscript{a}~value derived by the enrichment pipeline rather than directly measured; \textsuperscript{b}~minimum mass ($M \sin i$) rather than true mass; \textsuperscript{c}~radius estimated from mass or $M \sin i$ (not directly measured); \textsuperscript{d}~Exo-MerCat status is CANDIDATE or CONTROVERSIAL, not CONFIRMED.\par}
