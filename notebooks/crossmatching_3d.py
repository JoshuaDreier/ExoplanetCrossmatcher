...
class Crossmatcher3D(Crossmatcher):
    ...
    def coordinate_crossmatch(self, input_table, input_starname_key: str, ra_key="ra", dec_key="dec",
        ...
        super().coordinate_crossmatch(input_table, input_starname_key, ra_key, dec_key)
