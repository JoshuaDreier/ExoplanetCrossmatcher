...
def test_e2e_guinea_tics_id_all_found(stateless_matcher, star_name, ra, dec, planets_by_catalog):
    planets = planets_by_catalog[stateless_matcher._expected_planets_col]
    _e2e_all_planets_found(star_name, ra, dec, planets, stateless_matcher, id_crossmatch)
...
def test_e2e_guinea_tics_id_no_false_positives(stateless_matcher, star_name, ra, dec, planets_by_catalog):
    planets = planets_by_catalog[stateless_matcher._expected_planets_col]
    _e2e_no_false_positives(star_name, ra, dec, planets, stateless_matcher, id_crossmatch)
