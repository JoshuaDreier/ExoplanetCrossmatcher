...
def test_e2e_guinea_tics_id_all_found(star_name, ra, dec, sy_dist, expected_planets):
    test_e2e_all_planets_found(star_name, ra, dec, sy_dist, expected_planets, combined_crossmatch)    
...
def test_e2e_guinea_tics_id_no_false_positives(star_name, ra, dec, sy_dist, expected_planets):
    test_e2e_no_false_positives(star_name, ra, dec, sy_dist, expected_planets, combined_crossmatch)    
