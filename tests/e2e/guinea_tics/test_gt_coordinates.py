...
from tests.e2e.e2e_crossmatch_methods import coordinate_crossmatch_2d, coordinate_crossmatch_3d, stateless_matcher, loaded_matcher
...
def test_e2e_guinea_tics_coorinates_3d_all_found(stateless_matcher, star_name, ra, dec, sy_dist, expected_planets):
